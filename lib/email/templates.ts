        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 560px;">
          ...
          <tr>
            <td style="padding: 28px 16px 0 16px; text-align: center;">
              ...
              <p style="margin: 0; font-size: 11px;"><a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://naturescripts.io'}/settings" style="color: #a1a1aa; text-decoration: underline;">Manage email preferences</a> &middot; <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://naturescripts.io'}/settings" style="color: #a1a1aa; text-decoration: underline;">Unsubscribe</a></p>
            </td>
          </tr>
        </table>
      </td>

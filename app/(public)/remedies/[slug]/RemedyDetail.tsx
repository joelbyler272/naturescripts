        ...
        <div className="flex-1 min-w-0">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              {remedy.pharmaceuticalEquivalents && remedy.pharmaceuticalEquivalents.length > 0 && (
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-4">Natural Alternative To</h2>
                  <div className="space-y-3">
                    {remedy.pharmaceuticalEquivalents.map((pe, i) => (
                      <div
                        key={i}
                        className="p-4 bg-blue-50/50 border border-blue-100 rounded-xl flex items-start gap-3"
                      >
                        <Pill className="w-5 h-5 text-blue-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <span className="font-medium text-foreground">{pe.drug}</span>
                            <span className="text-xs px-2 py-0.5 bg-blue-100 text-blue-700 rounded">
                              {pe.drugClass}
                            </span>
                          </div>
                          <p className="text-sm text-muted-foreground">
                            Shared mechanism: {pe.mechanism}
                          </p>
                        </div>
                      </div>
                    ))}
                  ...
                  <p className="text-xs text-muted-foreground mt-3 flex items-center gap-1">
                    ...
                    This does not mean the remedy is equivalent in strength or effect. Always consult your healthcare provider before replacing any medication.
                  </p>
                </section>
              )}
